...
from circular_center.center2d.find_rectify_homography import (  # noqa: E402
    normalize_matrix_determinant,
)


class Center2dTest(unittest.TestCase):
    def test_identity_homography_normalization(self):
        normalized, scale = normalize_matrix_determinant(np.eye(3))
