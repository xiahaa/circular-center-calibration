...
每对图像和点云使用相同的数字文件名。公开数据包包含 67 对 lab、37 对 Office 和
7 对 ZJU 数据。作者侧审计使用的未遮挡 lab 图像不是公开复现所需数据。
...
先完成根目录 README 中的 [Installation](../../../README.md#installation)，然后预览前
10 帧：
...
检测器审计方法见 [`docs/dependencies/aamed.md`](../../dependencies/aamed.md)。
