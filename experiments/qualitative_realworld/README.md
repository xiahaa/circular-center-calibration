...
`configs/experiments/qualitative_realworld.yaml` and loaded from the central
`configs/methods` catalog. Adding a new interchangeable method does not require
editing this experiment.
